...
std::vector<double> extrudelength;
...
int main () {
  ...
  //char moveMsg="G1";
  lp.position.y=250.0;
  ifstream gcodefile ("/home/frederic/Documents/G-Codes/cube/20mm_cubeforUltimaker.gcode");
  if (gcodefile.is_open())
  {
    ...
    std_msgs::Float64MultiArray   extrudelength_msg;
