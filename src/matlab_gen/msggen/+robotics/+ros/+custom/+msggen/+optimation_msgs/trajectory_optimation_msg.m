classdef trajectory_optimation_msg < robotics.ros.Message
    %trajectory_optimation_msg MATLAB implementation of optimation_msgs/trajectory_optimation_msg
    ...
    properties (Constant)
        MessageType = 'optimation_msgs/trajectory_optimation_msg' % The ROS message type
    end
    ...
    methods
        function obj = trajectory_optimation_msg(msg)
            %trajectory_optimation_msg Construct the message object trajectory_optimation_msg
        ...
        function set.StartPose(obj, startpose)
            ...
            validateattributes(startpose, {obj.GeometryMsgsPoseClass}, {'nonempty', 'scalar'}, 'trajectory_optimation_msg', 'StartPose');
        ...
        function set.GoalPose(obj, goalpose)
            ...
            validateattributes(goalpose, {obj.GeometryMsgsPoseClass}, {'nonempty', 'scalar'}, 'trajectory_optimation_msg', 'GoalPose');
        ...
        function set.Time(obj, time)
            ...
            validateattributes(time, {obj.StdMsgsFloat32Class}, {'nonempty', 'scalar'}, 'trajectory_optimation_msg', 'Time');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.optimation_msgs.trajectory_optimation_msg.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.optimation_msgs.trajectory_optimation_msg;
            obj.reload(strObj);
        end
    end
end
