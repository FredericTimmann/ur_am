...
if("FALSE" STREQUAL "TRUE")
  set(mimic_joint_gazebo_tutorial_SOURCE_PREFIX /home/frederic/ur_am/src/mimic_joint_gazebo_tutorial)
  set(mimic_joint_gazebo_tutorial_DEVEL_PREFIX /home/frederic/ur_am/devel)
  ...
  set(mimic_joint_gazebo_tutorial_INSTALL_PREFIX /home/frederic/ur_am/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'mimic_joint_gazebo_tutorial' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/frederic/ur_am/install/${idir}'.  ${_report}")
    endif()
